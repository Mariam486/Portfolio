...
themeBtn.addEventListener('click', () => {
  dark = !dark;
  document.documentElement.style.setProperty('--bg', dark ? '#17161a' : '#f6f4f1');
  document.documentElement.style.setProperty('--bg-card', dark ? '#211f24' : '#ffffff');
  document.documentElement.style.setProperty('--ink', dark ? '#f4f1ee' : '#1c1a17');
  document.documentElement.style.setProperty('--ink-soft', dark ? '#b7b0a8' : '#6b6560');
  document.documentElement.style.setProperty('--line', dark ? '#332f34' : '#eae6e0');
